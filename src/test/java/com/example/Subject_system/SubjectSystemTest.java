...
public class SubjectSystemTest {
	...
	public void createCourseCheckCourseNameTest() {
		SubjectSystemRequest req = new SubjectSystemRequest("00002", " ", "三", 8, 10, 2);
	...
	public void createCourseCheckWeekDayTest() {
		SubjectSystemRequest req = new SubjectSystemRequest("00003", "java", "七", 8, 10, 2);
		SubjectSystemResponse res = subjectSystemService.createCourse(req);
		System.out.println("res:" + res.getMessage());
		SubjectSystemRequest req1 = new SubjectSystemRequest("00004", "java", "二", 8, 10, 2);
		SubjectSystemResponse res1 = subjectSystemService.createCourse(req1);
		System.out.println("res1:" + res1.getMessage());
	}
	...
	public void createCourseCheckTimeTest() {
		SubjectSystemRequest req = new SubjectSystemRequest("00005", "java", "五", 8, 25, 2);
		SubjectSystemResponse res = subjectSystemService.createCourse(req);
		System.out.println("res:" + res.getMessage());
		SubjectSystemRequest req1 = new SubjectSystemRequest("00006", "java", "五", 0, 19, 2);
		SubjectSystemResponse res1 = subjectSystemService.createCourse(req1);
		System.out.println("res1:" + res1.getMessage());
		SubjectSystemRequest req2 = new SubjectSystemRequest("00006", "java", "五", 18, 15, 2);
		SubjectSystemResponse res2 = subjectSystemService.createCourse(req2);
		System.out.println("res2:" + res2.getMessage());
		SubjectSystemRequest req3 = new SubjectSystemRequest("00007", "java", "五", 8, 10, 2);
		SubjectSystemResponse res3 = subjectSystemService.createCourse(req3);
		System.out.println("res3:" + res3.getMessage());
	}
	...
	public void createCourseCheckCreditsTest() {
		SubjectSystemRequest req = new SubjectSystemRequest("00008", "java", "五", 8, 10, 0);
		SubjectSystemResponse res = subjectSystemService.createCourse(req);
		System.out.println("res:" + res.getMessage());
		SubjectSystemRequest req2 = new SubjectSystemRequest("0009", "java", "五", 8, 10, 4);
		SubjectSystemResponse res2 = subjectSystemService.createCourse(req2);
		System.out.println("res2:" + res2.getMessage());
		SubjectSystemRequest req3 = new SubjectSystemRequest("0008", "java", "五", 8, 10, 3);
		SubjectSystemResponse res3 = subjectSystemService.createCourse(req3);
		System.out.println("res3:" + res3.getMessage());
	}
	//新增學生test
